 ...
 */
export function mergeNotes(local: Map<string, Note>, serverNotes: Note[]): Map<string, Note> {
...
export function mergeBoards(local: Map<string, Board>, serverBoards: Board[]): Map<string, Board> {
  const merged = new Map(local)
